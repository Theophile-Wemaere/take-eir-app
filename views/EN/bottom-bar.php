...
<div class="bottom-bar">
    <div class="row1">
        <div class="links">
            <a class="title">© TAKE-EIR</a>
            <a href="/index.php/mentions">Terms of use</a>
            <a href="/index.php/cgu">Terms and conditions</a>
            <a href="/index.php/faq">FAQ </a>
        </div>
        <div class="links">
            <a class="title">Website map</a>
            <a href="/index.php/presentation">Our team</a>
            <a href="/index.php/produit">Our product</a>
            <a href="/index.php/contact">Contact us</a>
        </div>
    </div>
    <div class="row2">
       This website was made with <i class="fa fa-heart"></i> by ISEP students, </br>
