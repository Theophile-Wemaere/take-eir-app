    ...
    <div class="faq-container">
      ...
      <div class="faq active">
        ...
        <p class="faq-text"> Vous pouvez accéder aux données de santé de votre proche à tout moment en vous connectant
          à notre plateforme en ligne sécurisée. Vous aurez besoin de vos identifiants de connexion pour accéder à votre
          compte.
          <br><br>
          Une fois que vous vous êtes connectés, vous pouvez vous rendre dans l'onglet 'Health-View' à partir du menu
          déroulant
          de votre session utilisateur. Cette page affichera alors toutes les données nécessaires pour évaluer la
          qualité de
      ...
      <div class="faq">
        ...
        <p class="faq-text">Pour créer un profil utilisateur sur le site web, il suffit de cliquer sur le bouton
          "Inscription" et de remplir le formulaire d'inscription en
          fournissant vos informations personnelles. Vous pourrez ensuite vous connecter avec l'email et le mot de passe
          indiqués.</p>
        <button class="faq-toggle">
          <i class="fas fa-angle-down"></i>
        </button>
      ...
      <div class="faq">
        ...
        <p class="faq-text"> Pour modifier les informations de votre profil utilisateur, il suffit de vous connecter à
          votre compte et de cliquer sur le bouton "Modifier le profil". Vous pourrez ensuite mettre à jour les
          informations de votre profil, comme votre adresse e-mail, votre mot de passe ou votre photo de profil.</p>
        <button class="faq-toggle">
          <i class="fas fa-angle-down"></i>
        </button>
      </div>
      ...
      <div class="faq">
        ...
        <p class="faq-text">Oui, Health-Eir est conçu pour être hautement sécurisé.
          ...
          sécurité avancés pour protéger les données de santé contre les accès non autorisés.
        </p>
        <button class="faq-toggle">
          <i class="fas fa-angle-down"></i>
        </button>
      ...
      <div class="faq">
        ...
        <p class="faq-text">Oui, vous pouvez donner accès à d'autres membres de votre famille pour consulter
          ...
          et de copier la clé 'Health-Key' correspondant à votre dispositif Health-Eir qu'il aura préalablement fallu
          enregistrer sur votre espace.
          <br><br>
          Vous pourrez ensuite transmettre à lien de connexion à un autre membre de la famille
          pour que celui-ci puisse pouvoir consulter les données de santé du patient.
        </p>
        <button class="faq-toggle">
          <i class="fas fa-angle-down"></i>
        </button>
