    ...
    <div class="wrapper">
        ...
        <div class="container">
            <div class="carousel">
                ...
                <div class="carousel__face"><span class="v2">Le concept</span></div>
                <div class="carousel__face"><span>d'hospitalisation à domicile</span></div>
                <div class="carousel__face"><span>Notre équipe</span></div>
                <div class="carousel__face"><span>a travaillé dur</span></div>
                <div class="carousel__face"><span class="v2">pour vous proposer</span></div>
                <div class="carousel__face"><span>ce produit d'exception</span></div>
                <div class="carousel__face"><span class="take-eir">Essayez-le !</span></div>
            </div>
        </div>
    </div>
    </div>
