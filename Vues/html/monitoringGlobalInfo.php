...
<html lang="fr">
<head>
    <link rel="stylesheet" href="/Vues/css/monitoringGlobalInfo.css" />
...
<body>
    <div class="top-bar">
        <div class="top-bar-img">
          <img src="/Vues/images/logo-notext.png" href="index.html" >
          <img src="/Vues/images/reglage.png" href = "">
          <img src="/Vues/images/barre-graphique.png" href="monitoringGlobalInfo.html">
        </div>
          
        <a href="produit.html"><button class="page-button">Notre produit</button></a> 
        <div class="separator"></div>
        <button class="page-button">Qui sommes nous ?</button>
        <a href="login.html"><button class="login-button">Médecin</button></a>
    ...
    <div class="tempData">
        ...
        <hr>
        <img src="/Vues/images/temp_data.png">
        <hr>
    ...
    <div class="noiseData">
        ...
        <hr>
        <img src="/Vues/images/noise_data.png">
        <hr>
    ...
    <div class="champ2">
        ...
        <div class="co2Data">
            ...
            <hr>
            <img src="/Vues/images/co2_data.png">
            <hr>
        ...
        <div class="dustData">
            ...
            <hr>
            <img src="/Vues/images/dust_data.png">
            <hr>
